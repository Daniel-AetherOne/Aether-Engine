...
class AetherDataset(Dataset):
    """Aether Engine dataset voor substrate en issues classificatie"""
...
def create_dataloaders(
    ...
    full_dataset = AetherDataset(csv_file, image_dir, mode="train")
    ...
    train_dataset = AetherDataset(csv_file, image_dir, mode="train")
    val_dataset = AetherDataset(csv_file, image_dir, mode="val")
    test_dataset = AetherDataset(
